  ...
  return (
    <div className="relative flex items-center justify-center min-h-[500px]">
      ...
      <motion.div
        ...
        className="absolute w-[400px] h-[400px] border border-plasma/30 rounded-full"
      />
      ...
      <motion.div
        ...
        className="absolute w-[320px] h-[320px] border-2 border-dashed border-solar/40 rounded-full"
      />
      ...
      <motion.div
        ...
        className="relative w-64 h-64 bg-gradient-to-tr from-void via-plasma/20 to-void 
